...
4. Replace **320746717615** in the whole project with your AWS Account ID
...
# Datacenter Map
Remember to adjust **320746717615** in workflow before execution.
...
* Replaced 320746717615 in the whole project (replace all in all files) with your AWS Account ID
  * **REMEMBER!** Push all changes to your forked repository!
